...
plt.plot(frame_numbers, psnr_values1, label='PSNR Video 1 vs Standard')
plt.plot(frame_numbers, psnr_values2, label='PSNR Video 2 vs Standard')
plt.xlabel('frame')
plt.ylabel('PSNR')
plt.legend()
...
plt.figure(figsize=(12, 6))
plt.plot(frame_numbers, ssim_values1, label='SSIM Video 1 vs Standard')
plt.plot(frame_numbers, ssim_values2, label='SSIM Video 2 vs Standard')
plt.xlabel('frame')
plt.ylabel('SSIM')
plt.legend()
...
plt.figure(figsize=(12, 6))
plt.plot(frame_numbers, mean_gradient_magnitude1, label='Gradient Magnitude Video 1')
plt.plot(frame_numbers, mean_gradient_magnitude2, label='Gradient Magnitude Video 2')
plt.xlabel('frame')
plt.ylabel('gradient')
plt.legend()
